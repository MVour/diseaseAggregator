...
def make_args_parser():
    ...
    parser.add_argument('--queryFile', default='../data/queryFile.txt',
    ...
    parser.add_argument('--commandsFile', default='../data/commandsFile.txt',
    ...
    parser.add_argument('--startDate', default='01-01-1970',
                        help='Start date', metavar='')
    parser.add_argument('--endDate', default='30-12-2040',
